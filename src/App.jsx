...
function NavigationBar() {
  {/* TODO: Add links */}
  return (
    <nav className="navbar navbar-expand-xxl navbar-dark pb-3 mb-3" style={{backgroundColor:"#37306B"}}>
      <div className="container-fluid">
        <ul className="navbar-nav nav nav-underline nav-fill">
          <li className="nav-item">
            <a className="nav-link" href="/" id="about-me">About Me</a>
          </li>
          <li className="nav-item">
        ...
        <div>
          <a href="https://github.com/janellamarie" target="_blank" className="m-2">
          ...
          <a href="https://www.linkedin.com/in/janella-marie-co/" target="_blank" className="m-2">
          ...
          <a href="mailto:co.janellamarie@gmail.com" target="_blank" className="m-2">
